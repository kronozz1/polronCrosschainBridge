...
try{
  ...
  console.log("hello user ",userAddress);
 ...
 <section class="body-font relative middle_box">
  <div class="container mx-auto">
    <div class="flex flex-col w-full mb-8">
      ...
      <p class=" leading-relaxed text-white ">Here you can swap POLRON(BSC) to POLRON(Goerli)</p>
    </div>
  <div class="row">
 <div class="box-50">
  <div class="box_white">
...
:
		...
		<p class="mb-2 text-gray-600">swap rate: 1:1 (1 POLRON(BSC) = 1 POLRON(Goerli))</p>
...
:
			...
			<img className="h-7 ml-2" src="bnb.png" />
                                  			 ...
                                  			 <img className="h-7 mb-[5px] ml-[15.5rem] mt-[9px] cursor-pointer" src="up-down.png" onClick={()=>reverseswaps()}/>
                    		<p class="mb-2 text-gray-600">swap rate: 1:1 (1 POLRON(Goerli) = 1 POLRON(BSC))</p>
